 ...
 * FormNumericValues
 *
 * @ORM\Table(name="tb_form_numeric_values")
 * @ORM\Entity(repositoryClass="Docova\DocovaBundle\Entity\FormNumericValuesRepository")
 */
class FormNumericValues
{
    /**
     * @var string
     *
     ...
     * @var float
     *
     * @ORM\Column(name="Field_Value", type="float")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Documents", inversedBy="Numeric_Values")
