 ...
 * WorkflowStepActions
 *
 * @ORM\Table(name="tb_workflow_step_actions")
 * @ORM\Entity
 */
class WorkflowStepActions
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="WorkflowSteps")
     * @ORM\JoinColumn(name="Back_Track_Step", referencedColumnName="id", nullable=true)
     */
    protected $Back_Track_Step;

    /**
     * @ORM\ManyToOne(targetEntity="WorkflowSteps", inversedBy="Actions")
     ...
     * @ORM\JoinTable(name="tb_step_action_senders",
     ...
     * Set Back_Track_Step
     *
     * @param null|\Docova\DocovaBundle\Entity\WorkflowSteps $step
     */
    public function setBackTrackStep(\Docova\DocovaBundle\Entity\WorkflowSteps $step = null)
    {
     ...
     * Get Back_Track_Step
     *
     * @return null|\Docova\DocovaBundle\Entity\WorkflowSteps
     */
     ...
     * Set Step
     * 
     * @param \Docova\DocovaBundle\Entity\WorkflowSteps $step
     */
    public function setStep(\Docova\DocovaBundle\Entity\WorkflowSteps $step)
    {
    	$this->Step = $step;
    }
     ...
     * Get Step
     * 
     * @return \Docova\DocovaBundle\Entity\WorkflowSteps
     */
     ...
     */
    public function setMessage(\Docova\DocovaBundle\Entity\SystemMessages $message)
    {
