...
/**
 * ArchivePoliciesRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class ArchivePoliciesRepository extends EntityRepository
{
	/**
	 * Get archive policies based on criteria as string or XML DomDocument
	 * 
	...
	public function getDataXML($criteria = array(), $sortBy = array(), $return_obj = false)
	{
		...
		foreach ($review_policies as $doc)
		{
			...
			if ($doc->getDocumentTypes()->count() > 0) 
			{
				...
				$doctypes = substr_replace($doctypes, '', -1);
			}
