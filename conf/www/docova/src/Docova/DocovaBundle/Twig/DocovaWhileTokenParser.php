...
//use Docova\DocovaBundle\Twig\DocovaWhileTagNode;


class DocovaWhileTokenParser extends \Twig_TokenParser 
{
   ...
   public function parse(\Twig_Token $token)
   {
        ...
        return new DocovaWhileTagNode($body, $id, $ifexpr, $token->getLine(), $this->getTag());
    }
   ...
   public function decideMyTagEnd(\Twig_Token $token)
   {
     ...
     return $token->test('enddocovawhile');
   }
