...
final class Schema extends BaseSchema
{
    ...
    protected function addEntryTable()
    {
        ...
        $table->addForeignKeyConstraint($this->getTable($this->options['class_table_name']), array('class_id'), array('id'), array('onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION'));
        $table->addForeignKeyConstraint($this->getTable($this->options['oid_table_name']), array('object_identity_id'), array('id'), array('onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION'));
        $table->addForeignKeyConstraint($this->getTable($this->options['sid_table_name']), array('security_identity_id'), array('id'), array('onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION'));
    }
    ...
    protected function addObjectIdentityAncestorsTable()
    {
        ...
        $table->addForeignKeyConstraint($oidTable, array('object_identity_id'), array('id'), array('onDelete' => 'NO ACTION', 'onUpdate' => 'NO ACTION'));
